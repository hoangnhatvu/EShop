...
<c:url value="/admin/orders/update" var="update"></c:url>
					...
					<div class="card-body">
						...
						<form role="form" action="${update}" method="post">
							...
							<c:if test="${order.id == 0}">
								...
								<div class="mb-3">
									<label for="productname" class="form-label">Order
										Id:</label> <input type="text" name="id" class="form-control"
										value="${order.id}" aria-describedby="productName"
										readonly="true">
								</div>
							...
							<div class="mb-3">
								<label for="productname" class="form-label">Order
									...
									value="${order.name}" aria-describedby="productName"
